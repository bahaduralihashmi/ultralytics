...
def merge_equals_args(args: list[str]) -> list[str]:
    """Merges arguments around isolated '=' in a list of strings, handling three cases: 1. ['arg', '=', 'val'] becomes
    ['arg=val'], 2. ['arg=', 'val'] becomes ['arg=val'], 3. ['arg', '=val'] becomes ['arg=val'].

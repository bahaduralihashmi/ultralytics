...
class MultiScaleAttention(nn.Module):
    ...
    This class provides a flexible implementation of multi-scale attention, allowing for optional downsampling of query
    features through pooling. It's designed to enhance the model's ability to capture multi-scale information in visual
    tasks.
...
class MultiScaleBlock(nn.Module):
    ...
    This class implements a multi-scale attention mechanism with optional window partitioning and downsampling, designed
